...
//		nme.Lib.stage.addChild ( createSprite() );

		for(i in 0...500)
		{
			var testComp = new OButtonBase();
			var styleTest = new OButtonBaseStyle();
			var brush = new BrushColorFill();
			brush.setColorState(OBaseStyle.STATE_DISABLED, ColorUtils.randomColor());
			brush.setColorState(OBaseStyle.STATE_ACTIVE, ColorUtils.randomColor());
			brush.setColorState(OButtonBaseStyle.STATE_DOWN, ColorUtils.randomColor());
			brush.setColorState(OButtonBaseStyle.STATE_OVER, ColorUtils.randomColor());
