...
@:expose("Coordinates.layouts.threedee.Spheroid3d")
class Spheroid3d extends Layout3d ,implements ILayout3d
{
	 ...
	 */
	function get_rotationX():Float { return this.rotation; }
	...
	public function distributeNodes(iterations:Int=15):Void
	{
		...
		for(i in 0...size)
		{
			var v:Vertex = new Vertex(Math.random()-0.5,Math.random()-0.5,Math.random()-0.5);
			this.verts.push(v);
		}
